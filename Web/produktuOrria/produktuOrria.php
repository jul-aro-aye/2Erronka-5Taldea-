    ...
    <body>
        ...
        <h1 id="enpresaIzena">EkoTekno</h1>
            ...
            <div id="karritoa-ikonoa">
                <a href="karritoa.php"><i class="fa fa-shopping-cart" id="karritoa" ><span id="karrito-kopurua">0</span></i></a>
            </div>
            <div id="produktuak">
                <?php
                if ($emaitza->num_rows > 0) {
                    while ($row = $emaitza->fetch_assoc()) {
                        if (strpos(strtolower($row["izena"]), strtolower($bilatu)) !== false) {
                            ...
                            echo "<button onclick=\"gehituSaskira('" . htmlspecialchars($row["izena"]) . "', " . $row["prezioa"] . ")\" id='gehituSaskira'>Gehitu saskira</button>";
                            echo "</div>";
                        }
                    }
                } else {
        ...
        <script>
            function gehituSaskira(izena, prezioa) {
                ...
                if (aurkitua) {
                    ...
                    karritoa.push({ izena, prezioa, kopurua: 1 });
                }
            ...
            function eguneratuKarritoa() {
                ...
                document.getElementById("karrito-kopurua").textContent = guztira;
            }
