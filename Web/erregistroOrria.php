...
<body>
    ...
    <form>
        ...
        <input type="text" id="erabiltzailea" name="erabiltzailea" required pattern="^[a-z]{3}_[a-z]{3}_[a-z]{3}$"
            title="Erabiltzailearen formatua ez da okerra, formatu egokia (xxx_xxx_xxx) da." placeholder="xxx_xxx_xxx"> <br><br>
        ...
        <input type="text" id="jaio_urtea" name="jaio_urtea" placeholder="0000-00-00"
            pattern="[0-9]{4}\-[0-9]{2}\-[0-9]{2}" title="Jaio_Urtearen formatua ez da egokia (xxxx-xx-xx)" required> <br><br>
