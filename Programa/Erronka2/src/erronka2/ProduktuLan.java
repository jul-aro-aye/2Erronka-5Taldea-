...
public class ProduktuLan extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProduktuLan frame = new ProduktuLan();
...
//				"1MG3EkoTekno@");
		...
		try {
			...
			gehituProduktua.setBounds(700, 60, 100, 20);
			...
			eguneratuProduktua.setBounds(700, 100, 100, 20);
